...
const CATEGORY_MAP = [
  ...
  [/\bspeaker/i,                           'Speakers'],
  [/\bwatch/i,                             'Watches'],
  [/\btelevision|smart tv|led tv/i,        'Television'],
  [/refrigerator|\bfridge\b/i,             'Refrigerators'],
  [/printer|scanner/i,                     'Scanners and Printers'],
  [/power bank|\bcharger/i,                'Power Banks and Chargers'],
  ...
  [/sunglass|eyewear|spectacle/i,          'Eyewear Sunglasses Frames'],
  [/luggage|suitcase|\btravel\b/i,         'Luggage - Other Products'],
  [/backpack|rucksack/i,                   'Backpacks'],
  [/handbag|\bbag\b|wallet|clutch/i,       'Handbags'],
  ...
  [/mattress/i,                            'Mattresses'],
  [/bedsheet|bed\s*sheet|bedding|blanket|duvet|comforter/i, 'Bedsheets Blankets Covers'],
  [/wall art|\bpainting|\bposter/i,        'Wall Art'],
  [/bicycle|cycling|\bcycle\b/i,           'Bicycles'],
